...
if [ "$stick" = 'RSP1' ];then
xterm -geometry 88x56+22+0 -bg brown -fg white -fa ‘verdana’ -fs 9x -T DUMP1090 -e sudo ./dump1090 --net --interactive --dev-sdrplay --net-ro-port $puerto --ppm $ppm --net-http-port $http
